...
<form id="rmform" name="rmform" method="post" action="">
  ...
  <input name="SendTo" type="hidden" id="SendTo" value="Boxingworkshermosa@gmail.com,mikethemisfitkoelzer@gmail.com" />
  <input name="rmid" type="hidden" id="rmid" value="" /> 
  <input name="formID" type="hidden" id="formID" value="6BAD62B41BB0E8DA42E62E9A" />
  ...
  <div class="form-group">
    <input type="text" class="form-control" id="LName" name="Lame" placeholder="Last Name" required>
  </div>
...
<div id="myModal" class="reveal-modal" data-reveal>
  ...
  <p>Im a cool paragraph that lives inside of an even cooler modal. Wins</p> <a class="close-reveal-modal">&#215;</a> 
</div>